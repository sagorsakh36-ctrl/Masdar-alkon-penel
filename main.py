...
class OTPMonitorBot:
    def __init__(self, telegram_token, group_chat_id, session_cookie, target_url, target_host):
        ...
        self.csstr = "e690957a6137960a3dbb02d9e2450249"  # New csstr parameter
    ...
    def fetch_sms_data(self):
        ...
        timestamp = str(int(time.time() * 1000))  # Generate current timestamp for _ parameter
        ...
        params = {
            ...
            'fgnumber': '', 'fgcli': '', 'fg': '0',
            'csstr': self.csstr,  # New parameter added
            ...
            '_': timestamp  # Dynamic timestamp parameter
        }
...
async def main():
    # Updated configuration with new values from the request
    TELEGRAM_BOT_TOKEN = "8724769053:AAH1V_RQQ3SuS6PbCrHsWMrRxCvTnmEyd-M"
    GROUP_CHAT_ID = "-1003796890472"
    SESSION_COOKIE = "8a795d1893e89fefb5185d82eb7cf203"  # Updated session cookie
